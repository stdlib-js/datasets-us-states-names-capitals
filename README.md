...
```javascript
table = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names-capitals@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var table = require( 'path/to/vendor/umd/datasets-us-states-names-capitals/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names-capitals@v0.2.2-umd/browser.js"></script>
```
