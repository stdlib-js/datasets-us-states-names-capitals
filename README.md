...
```javascript
table = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names-capitals@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names-capitals@umd/bundle.js"></script>
```
